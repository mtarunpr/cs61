...
extern uint8_t _binary_obj_p_pipewriter_start[];
extern uint8_t _binary_obj_p_pipewriter_end[];
extern uint8_t _binary_obj_p_pipereader_start[];
extern uint8_t _binary_obj_p_pipereader_end[];
...
struct ramimage {
    ...
    { "pipewriter", _binary_obj_p_pipewriter_start, _binary_obj_p_pipewriter_end },
    { "pipereader", _binary_obj_p_pipereader_start, _binary_obj_p_pipereader_end }
};
