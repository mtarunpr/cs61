...
#define SYSCALL_SPAWN           7
#define SYSCALL_GETTICKS        8
#define SYSCALL_PIPEWRITE       9
#define SYSCALL_PIPEREAD        10
...
// Number of ticks per second = timer interrupt frequency (/sec)
